package com.liang.tind.mycv.widget.specialprolibrary;
...
public class SpecialProgressBarView extends View {
    private static final String TAG = "SpecialProgressBarView";
    //画笔
    ...
    private StateChangedAnimationEndListener mStateChangedAnimationEndListener;
    ...
    public void setOptionsLoadingDrawable(BitmapFactory.Options optionsLoadingDrawable) {
        if (optionsLoadingDrawable != null) {
            ...
            loadingBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_chat_bubble_white_36dp, optionsLoadingDrawable);
        }
    }
    ...
    public void setStateChangedAnimationEndListener(StateChangedAnimationEndListener stateChangedAnimationEndListener) {
        mStateChangedAnimationEndListener = stateChangedAnimationEndListener;
    }
    ...
    public SpecialProgressBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        startDrawable = typedArray.getResourceId(R.styleable.SpecialProgressBarStyle_startDrawable, R.mipmap.ic_get_app_white_36dp);
        endSuccessDrawable = typedArray.getResourceId(R.styleable.SpecialProgressBarStyle_endSuccessDrawable, R.mipmap.ic_done_white_36dp);
...
//		mBgPaint.setStrokeJoin(Join.ROUND);
        ...
        p = new Path();
        downloadBitmap = BitmapFactory.decodeResource(getResources(), startDrawable);
        loadingBitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_chat_bubble_white_36dp);
        ...
        switch (state) {
            ...
            case STATE_STARTING:
                ...
                if (state == STATE_ERROR) {
                    ...
                    if (mStateChangedAnimationEndListener != null) {
                        postDelayed(() -> mStateChangedAnimationEndListener.onErrorAnimationEnd(), 200);
                    }
                } else {
                    if (state != STATE_SUCCESS)
...
//                    va.cancel();
    ...
    private void changeStateBackHome() {
        ...
        ValueAnimator va = ValueAnimator.ofInt((int) mBgPaint.getStrokeWidth(),
                (int) (Math.min(getWidth(), getHeight()) - mBgPaint.getStrokeWidth() * 2) / 2);
        va.setInterpolator(new AnticipateOvershootInterpolator());
        va.setDuration(800);
        ...
        va.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                postDelayed(new Runnable() {
                    ...
                    public void run() {
                        state = DONE;
                        mStateChangedAnimationEndListener.onSuccessAnimationEnd();
                    }
                }, 50);
            }
    ...
    public interface StateChangedAnimationEndListener {
